	...
	*/
	public class Graficador {
		...
		*/
		...
		/**
		*Método que regresa un entero con la coordenada x correspendiente segun el porcentaje
		*@return Entero con el valor de X
		*/
		public int coordenadaX(int porcentaje){
			return (int)Math.cos(2 * Math.PI * porcentaje) ;
		}

		/**
		*Método que regresa un entero con la coordenada Y correspendiente segun el porcentaje
		*@return Entero con el valor de Y
		*/
		public int coordenadaY(int porcentaje){
			return (int)Math.sin(2 * Math.PI * porcentaje) ;
		}
		...
		*/
		public String pastel(Lista<Palabra> palabras) {
			...
			sp.append(String.format(INICIO_SVG,230,230));
			sp.append("class=chart");
			sp.append(String.format(CIRCLE, 115, 115, 150,"fill=red", 7));
	    		sp.append("\t" + CIERRA_SVG);
			return sp.toString();
		}
