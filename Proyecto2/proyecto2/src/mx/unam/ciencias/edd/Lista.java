...
//--------------------------------------------------------------------------------------------------------------------
    /**
    * Método auxiliar privado que recibe dos listas y las mezcla, y regresa una lista ordenada.
    * Para poder hacer el
    ...
    * @param Lista uno.
    * @param lista dos.
    * @return una lista con los elementos de las dos listas pero ordenados.
    */
    ...
    public Lista<T> mergeSort(Comparator<T> comparador) {
        ...
        return mezcla(izq,der,comparador);
    }
