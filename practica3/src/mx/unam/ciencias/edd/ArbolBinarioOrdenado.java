...
extends ArbolBinario<T> {
   ...
   private VerticeArbolBinario<T> busca(T elemento, Vertice v){
    ...
    public void giraDerecha(VerticeArbolBinario<T> vertice) {
        giraDerechaAux((Vertice)vertice);
    }
    private void giraDerechaAux(Vertice vertice) {
    ...
    public void giraIzquierda(VerticeArbolBinario<T> vertice) {
        giraIzquierdaAux ((Vertice)vertice);
    }
    private void giraIzquierdaAux(Vertice vertice) {
