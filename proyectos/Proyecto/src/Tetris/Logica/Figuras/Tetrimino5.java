...
public class Tetrimino5 implements Figura{
    ...
    public Tetrimino5(){
        posicion=0;
        puntos0=new Punto2D[]{new Punto2D(0,0),new Punto2D(0,1),new Punto2D(1,1),new Punto2D(1,0)};
        puntos90=new Punto2D[]{new Punto2D(0,0),new Punto2D(0,1),new Punto2D(1,1),new Punto2D(1,0)};
