...
private Vertice castVertice(VerticeGrafica<T> v) {
    ...
    private boolean ar(Vertice a, Vertice b, Lista<String> lista){
        String string = "("+a.elemento+", "+b.elemento+")";
        String string2 = "("+b.elemento+", "+a.elemento+")";
        return lista.contiene(string) || lista.contiene(string2);
    }
	...
	for (Vertice v : this.vertices) {
		...
		if(!ar(v,c,lista))
		    lista.agrega("("+v.elemento+", "+c.elemento+")");
	    }
	}
	s += lista.toString();
	s = s.replace("[","");
