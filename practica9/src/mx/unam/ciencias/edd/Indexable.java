...
public class Indexable<T> implements ComparableIndexable<Indexable<T>> {
    ...
    @Override public int compareTo(Indexable<T> indexable) {
       return Double.compare(this.valor, indexable.valor);
   }
    ...
    @Override public boolean equals(Object o) {
       if (o == null || getClass() != o.getClass())
        return false;
    @SuppressWarnings("unchecked") Indexable<T> aux = (Indexable<T>)o;
    if(aux.indice== this.indice && aux.valor==this.valor && aux.elemento.equals(this.elemento))
        return true;
    return false;    
